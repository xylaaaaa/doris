...
class PluginDrivenInsertExecutorTest {
    ...
    @Test
    void rejectsMissingFilesForNonEmptyFileInsert() {
        Assertions.assertThrows(UserException.class,
                () -> PluginDrivenInsertExecutor.validateReportedFiles(
                        ConnectorWriteType.FILE_WRITE, false, List.of(), "events"));
    }

    @Test
    void allowsMissingFilesForEmptyOrNonFileInsert() {
        Assertions.assertDoesNotThrow(
                () -> PluginDrivenInsertExecutor.validateReportedFiles(
                        ConnectorWriteType.FILE_WRITE, true, List.of(), "events"));
        Assertions.assertDoesNotThrow(
                () -> PluginDrivenInsertExecutor.validateReportedFiles(
