...
public class PluginDrivenExternalCatalogDropTest {
    ...
    public void testDropResolvesRemoteHandleAndInvalidatesLocalTable() throws Exception {
        Fixture fixture = fixture(Set.of(ConnectorCapability.SUPPORTS_DROP_TABLE), true);

        Assertions.assertTrue(fixture.catalog.dropTableFromConnector(
                "local_db", "events", false));

        Mockito.verify(fixture.metadata).dropTable(
    ...
    public void testDropIfExistsCleansStaleLocalTable() throws Exception {
        Fixture fixture = fixture(Set.of(ConnectorCapability.SUPPORTS_DROP_TABLE), false);

        Assertions.assertTrue(fixture.catalog.dropTableFromConnector(
                "local_db", "events", true));

        Mockito.verify(fixture.metadata, Mockito.never()).dropTable(
                Mockito.any(), Mockito.any());
        Mockito.verify(fixture.database).unregisterTable("events");
    }

    @Test
    public void testDropRequiresConnectorCapability() {
        Fixture fixture = fixture(Set.of(), true);

        Assertions.assertThrows(DdlException.class,
                () -> fixture.catalog.dropTableFromConnector(
                        "local_db", "events", false));
    }
